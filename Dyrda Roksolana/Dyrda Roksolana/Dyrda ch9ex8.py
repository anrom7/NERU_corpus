# Roksolana Dyrda, AL-13, розділ 9, завдання 8

import nltk
# Введення даних структури з умови
...
# Перевірка результатів даних структури (з використанням nltk)
...
print 'Unification of the 5th and 7th feature structure:', fs5.unify(fs7)# Дані структури не обєднаються(None unification)
